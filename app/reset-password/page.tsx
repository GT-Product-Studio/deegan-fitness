      ...
      <main className="min-h-screen flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-sm text-center">
          ...
          <div className="bg-card border border-white/10 rounded-2xl p-6">
            <div className="w-14 h-14 bg-primary/10 flex items-center justify-center mx-auto mb-5 rounded-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                minLength={6}
                className="w-full bg-background border border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-primary transition"
                placeholder="••••••••"
              />
            </div>
